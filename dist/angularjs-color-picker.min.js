...
b.initConfig(),
// setup mouse events
a.on("mousedown",b.onMouseDown),a.on("mouseup",b.onMouseUp),a.on("mousemove",b.onMouseMove),a.on("keydown",function(a){9===a.which&&b.$apply(function(){b.hide()})}),b.find(".color-picker-grid").on("click",b.onColorClick),b.find(".color-picker-hue").on("click",b.onHueClick),b.find(".color-picker-opacity").on("click",b.onOpacityClick)},b.onMouseDown=function(a){
